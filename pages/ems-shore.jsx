		...
		<div className='w-full'>
			<div className='w-screen h-[50vh] relative'>
				...
				<Image
					...
					Layout='fill'
					src={EsLandingPage}
					alt='A image of a website with pictures of leather wrap bracelets.'
				/>
			...
			<div className='max-w-[1240px] mx-auto justify-items-center p-2 px-4 grid md:grid-cols-5 gap-8 py-8'>
				<div className='col-span-4'>
					...
					<div className='grid grid-cols-2 justify-items-center gap-10 w-full pt-5 pb-10 my-6'>
						<a
							className='justify-self-center w-[100%] md:w-[50%] hover:scale-105 ease-in-out duration-300'
